...
monzon_mask_HS = mon_range_CanESM2_HS.where(mon_range_CanESM2_HS > 2)/mon_range_CanESM2_HS.where(mon_range_CanESM2_HS > 3)
monzon_mask_HN = mon_range_CanESM2_HN.where(mon_range_CanESM2_HN > 2)/mon_range_CanESM2_HN.where(mon_range_CanESM2_HN > 3)
...
HS = HS_monson.sel(time=HS['time.season']=='DJF').mean(dim='time')
cyclic_data_HS, cyclic_lons = add_cyclic_point(HS, coord=lon)
HN_monson = CanESM2_ens.pr*monzon_mask_HN
HN = HN_monson.sel(time=HN['time.season']=='JJA').mean(dim='time')
